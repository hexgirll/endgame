...
void init_level(e_game_state current_state, t_platform *platforms, t_moving_platform *m_platforms, t_coin *coins) {
        ...
        if (current_state == LEVEL2) {
            ...
            platforms[1] = (t_platform){{400, 680}, {126, 1}, LoadTexture("resource/textures/platforms/platform2.png"), 1.0f, 1.0f, 15 * 1.0f};
            platforms[2] = (t_platform){{700, 600}, {240, 1}, LoadTexture("resource/textures/platforms/platform3.png"), 1.05f, 1.05f, 25 * 1.2f};
            platforms[3] = (t_platform){{1100, 550}, {255, 1}, LoadTexture("resource/textures/platforms/platform4.png"), 0.7f, 0.7f, 25 * 0.7f};
            platforms[4] = (t_platform){{1350, 700}, {160, 1}, LoadTexture("resource/textures/platforms/platform5.png"), 0.8f, 0.8f, 25 * 0.9f};
            platforms[5] = (t_platform){{900, 400}, {235, 1}, LoadTexture("resource/textures/platforms/platform6.png"), 0.8f, 0.8f, 15 * 0.8f};


            m_platforms[0] = (t_moving_platform){{300, 500}, {126, 1}, {300, 500}, {600, 500}, LoadTexture("resource/textures/platforms/platform2.png"), 1.0f, 1.0f, 15 * 1.0f, 2.0f, 2};
            ...
            coins[1].position = (Vector2){ 370, 470 };
            coins[2].position = (Vector2){ 400, 250 };
            coins[3].position = (Vector2){ 680, 450 };
            coins[4].position = (Vector2){ 1400, 650 };
            coins[5].position = (Vector2){ 750, 100 };
            coins[6].position = (Vector2){ 1290, 70 };
