...
static void handle_mouse_clicks(Vector2 mouse_point, Rectangle play_button, Rectangle exit_button,
                        Rectangle sound_button_rect, Music *music, bool *is_muted, float *music_volume, e_game_state *current_state) {
...
void create_menu(e_game_state *current_state, Music *music, Texture2D background, Texture2D button_texture_1, Texture2D button_texture_2, 
    ...
    handle_mouse_clicks(mouse_point, play_button, exit_button, 
                        sound_button_rect, music, is_muted, music_volume, current_state);
    EndDrawing();
}